-- 1. Create a trigger that converts each newly inserted student name into Uppercase
for table student.
...
-- 2. Create a trigger that insert a tuple into studentinfo table after a tuple is inserted
into student table.
...
-- 3. Create a trigger that updates name in studentinfo table after a name is updated
in student table.
...
-- 4. Create a trigger that deletes a tuple from studentinfo table after a tuple is
deleted from student table.
...
-- 5. Create a trigger that insert a tuple into oldstudent table before a tuple is deleted
from student table.
